...
use deno_core::{
  include_js_files, ExtensionFileSource, ExtensionFileSourceCode,
};
use deno_io::Stdio;
...
impl MainWorker {
  ...
  pub fn from_options(
    ...
    let mut extensions: Vec<Extension> = vec![
      ...
      deno_fs::deno_fs::init_ops_and_esm::<PermissionsContainer>(false),
      runtime::init_ops_and_esm(),
      // FIXME(bartlomieju): these extensions are specified last, because they
      // depend on `runtime`, even though it should be other way around
      deno_node::deno_node::init_ops_and_esm::<PermissionsContainer>(None),
